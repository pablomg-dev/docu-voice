...
export default function ExportButtons({ sessionId, title }: ExportButtonsProps) {
  ...
  return (
    <button
      ...
      className="flex min-h-[44px] items-center gap-2 rounded-lg border border-gray-700 px-4 py-2 text-sm font-medium text-gray-300 transition-colors hover:border-gray-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
    >
